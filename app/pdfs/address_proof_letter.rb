class AddressProofLetter < Prawn::Document
  ...
  def text
    draw_text "This is to confirm that <Employee Name> is a bonafide employee and is working as", size: 12, :at => [@x+40, @y-250]
    draw_text "<Designation> since <DOJ>, for Amzur Technologies Pvt Ltd and as per the company", size: 12, :at => [@x+40, @y-270]
