...
class AppraisalsController < ApplicationController
  ...
  before_filter :reporting_manager_view, only: [:assign_appraisal, :assign_employee_appraisals, :manager_view, :employee_appraisals, :manager_view, :manager_feedback, :manager_appraisal_view, :reportees, :reportee_appraisals, :reportee_appraisal_view, :reportee_appraisal_edit, :reportee_appraisal_update]
