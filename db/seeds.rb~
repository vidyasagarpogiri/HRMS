...
Employee.create(:employee_id => 1, :title=> "Mr.", :first_name=>"Sekhar",:last_name=>"Beri",:date_of_birth=>"1989-08-20", :gender=>"male", :marital_status=>"single", :total_experience=>"1",:status=>"Active", :mobile_number=>"9985103763",:father_name=>"Adinarayana",:pan=>"pan", :date_of_confirmation=>"2013-05-09",:date_of_join=>"2014-06-01",:image_url=> "image",:department_id =>2,:blood_group_id=> BloodGroups[rand(BloodGroups.length)],
:ff_status_id=>FfStatuses[rand(FfStatuses.length)], :job_location_id=>JobLocations[rand(JobLocations.length)],:avatar=>"406929_2668579486846_928068538_n.jpg", :user_id => @user.id, :alternate_email => "sekhar.mca270@gmail.com")
