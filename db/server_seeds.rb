...
Employee.create(:employee_id => 1, :title=> "Mr.", :first_name=>"shankar Rao",:last_name=>"Piriya",:date_of_birth=>"2014-12-30", :gender=>"male", :marital_status=>"single", :total_experience=>"6.5",:status=>"Active", :mobile_number=>"9876543219",:father_name=>"Father",:pan=>"pan", :date_of_confirmation=>"2013-05-09",:date_of_join=>"2014-03-03",:image_url=> "image",:department_id =>2,:blood_group_id=> BloodGroups[rand(BloodGroups.length)],
...
Event.create(:name =>"Pongal", :event_date => "14/01/2014")
Event.create(:name =>"Ugadi", :event_date => "11/04/2014")
Event.create(:name =>"Independence Day", :event_date => "15/08/2014")
Event.create(:name =>"Raksha Bhandan", :event_date => "23/08/2014")
Event.create(:name =>"Vinayaka Chaturthi", :event_date => "29/08/2014")
Event.create(:name =>"Dussehra", :event_date => "04/10/2014")
Event.create(:name =>"Diwali", :event_date => "14/11/2014")
Event.create(:name =>"Naga Panchami", :event_date => "21/11/2014")
Event.create(:name =>"Thanks Giving Day", :event_date => "27/11/2014")
Event.create(:name =>"Christmas", :event_date => "25/12/2014")
