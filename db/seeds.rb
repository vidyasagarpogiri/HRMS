...
address = Address.create(:line1 => "street 1",:line => "near KFC",:city => "Vizag",:state=>"Andhra",:country=>"India",:zipcode=>"530003")
JobLocation.create( :address_id => address.id )


Employee.create(:employee_id => 1, :title=> "Mr", :first_name=>"BalaRaju",:last_name=>"Vankala",:date_of_birth=>"2014-12-30", :gender=>"male",:mobile_number=>"9876543219",:father_name=>"Adinarayana",:date_of_join=>"2014-03-03",:image_url=> "image",:department_id =>2,:blood_group_id=> BloodGroups[rand(BloodGroups.length)],:avatar=>"406929_2668579486846_928068538_n.jpg", :user_id => @user.id, :alternate_email => "balaraju.vankala@gmail.com")
