...
RSpec.describe Project, :type => :model do
    describe Project do
      ...
      expect(Project.create(title: "hrms", description: "some text", start_date: "Fri, 21 Sep 2014", end_date: "Fri, 21 Nov 2014", roles: "some role1,some role2", tasks_performed: "task1,task2", skills: "skill1,skill2", employee_id: 1)).to_not be_valid
      end
